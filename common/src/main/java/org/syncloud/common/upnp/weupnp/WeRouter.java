...
public class WeRouter implements Router {

    private Logger logger = Logger.getLogger(WeRouter.class);

    private GatewayDevice device;

    public WeRouter(GatewayDevice device) {
        this.device = device;
    }
    ...
    private List<PortMappingEntry> getPortMappings() {
        ...
        while (true) {
            ...
            try {
                ...
                logger.error("unable to get mappong: " + e.getMessage());
            }
